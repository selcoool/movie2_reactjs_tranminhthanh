...
import { editAUser, getAllUsers } from '../redux/userReducer';
const { TextArea } = Input;

function ModalEditUser({visible,setVisible,data,group,setGroup}) {


      // console.log('modalCreateUser',group)
        ...
        onSubmit: async(values) => {
           try {
                  ...
                  //  console.log('onSubmitvaluesxxxxxxxxxx',values)
                    ...
                    // console.log('RRRRRRRRRRRRRRRRR',values)
                      
                   await dispatch(editAUser({formData:values}))
                   await dispatch(getAllUsers({group}))
                      setVisible(false)
                  //  setSelectedDate()
                  //  setVisible(false)
